...
namespace Skyray.UC
{
    ...
    public partial class UCCameraControl : Skyray.Language.UCMultiple
    {
        ...
        private void initLargeView()
        {
            ...
            {
                this.largeCameraLightBar.Visible = false;
                this.lblLargeCameraLight.Visible = false;
            ...
            {
                this.largeCameraLightBar.Visible = true;
                this.lblLargeCameraLight.Visible = true;
        ...
        public static void addCheckTime(string filePath, string data)
        {
            try
            {
                // 检查文件是否存在
        ...
        public void selfCheck()
        {
            ...
            do
            {
                ...
                addCheckTime(path, System.DateTime.Now.ToString());
                int sleepTime = 15000;
            ...
            addSteps(path, curXSteps.ToString(), curYSteps.ToString());
            WorkCurveHelper.loopTestDemo = bool.Parse(ReportTemplateHelper.LoadSpecifiedParamsValue(AppDomain.CurrentDomain.BaseDirectory + "AppParams.xml", "application/loopTestDemo"));
