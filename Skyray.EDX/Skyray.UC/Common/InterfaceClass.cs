...
namespace Skyray.UC
{
    ...
    && WorkCurveHelper.WorkCurveCurrent.ElementList != null && WorkCurveHelper.WorkCurveCurrent.ElementList.Items.Count > 0
        ...
        public virtual void DisappearBk()
        {
            ...
            entityes.Add(this.specList);
            OpenWorkSpec(entityes, true);
        }
        ...
        public long deleteId = 0;

        public void deleteErrorRecord()
        {
            DbObjectList<HistoryRecord> records = HistoryRecord.FindRecent(1);
            deleteId = records[0].Id;
        ...
        public bool isFirstCal = true;
        public double firstCalThick = 0;
        public bool isTestCal = true;
        /// <summary>
        ...
        public virtual void RefreshHistoryRecord(SpecListEntity specList, WorkCurve workCurve)
        {
            ...
            {
                MethodInfo myMethod = WorkCurveHelper.curFrmThickType.GetMethod("updateRetestRecord");
        ...
        public DataTable GetReportDT12(Report report, ElementList elementList, List<long> selectLong)   //yuzhaoadd:获取打印数据
        {
                    ...
                    if (elementList.Items.ToList().Find(a => a.Caption == element.Caption && a.IsShowElement) != null)
                    {
                        ...
                        else
                        {
                            if (ThickCollection.Count > 0 && ThickCollection[ThickCollection.Count - 1].Contains(element.LayerNumber.ToString()))
                            {
                                ...
                                if (!ThickCollection[ThickCollection.Count - 1].Contains(element.Caption))
                                {
            ...
            if (FpWorkCurve.thickMode == ThickMode.NiNi || FpWorkCurve.thickMode == ThickMode.NiCuNi || FpWorkCurve.thickMode == ThickMode.NewNiCuNi)
            {
                ...
                foreach (DataColumn dctemp in dt.Columns)
                {
                    ...
                    if (dctemp.ColumnName.Contains(colName + " 3 " + Info.Thick))
                    {
        ...
        public DataTable GetReportDT19(Report report, ElementList elementList, List<long> selectLong)   //yuzhaoadd:获取打印数据
        {
            ...
            {
                if ((a.LayerNumBackUp == "基材" || a.LayerNumBackUp == Info.Substrate || a.LayerNumBackUp == "Substrate") && !a.IsShowElement)
