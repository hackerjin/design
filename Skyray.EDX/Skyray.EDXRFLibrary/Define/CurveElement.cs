...
namespace Skyray.EDXRFLibrary
{
    ...
    public abstract class CurveElement : DbObjectModel<CurveElement>, ICloneable
    {
       ...
       [Length(ColLength.SpecDataByte)]
        ...
        /// 是否激活增加LB
        /// </summary>
        public abstract bool IsActiveLb { get; set; }
        ///// <summary>
        ///// 激活的LB线系
        ///// </summary>
        //public abstract XLine LbXLine { get; set; }

        /// <summary>
        /// LB 左
        /// </summary>
        public abstract int LPeakLeft { get; set; }

        /// <summary>
        /// LB 右
        /// </summary>
        public abstract int LPeakRight { get; set; }

        /// <summary>
        /// 是否扣除
        /// </summary>
        public abstract bool IsDeduct { get; set; }
