...
namespace Skyray.EDX.Common.Component
{
    public class NetPortImplement : DeviceInterface
    {
        ...
        private ushort isAdjustFineGain = 0;
        ...
        public override void DoTest(object obj)
        {
            ...
            if (WorkCurveHelper.WorkCurveCurrent.Condition != null && DeviceParam.IsAdjustRate)
            {
                DeviceParam.TubCurrent = DeviceParam.FaceTubCurrent;
            ...
            Begin:
                ...
                if (WorkCurveHelper.isAdjustSpecData && isAdjustFineGain == 1 && usedTime >= 1)
                {
                    ...
                    System.Reflection.MethodInfo myMethod = WorkCurveHelper.curFrmThickType.GetMethod("countRate");
                    float countRate = (float)myMethod.Invoke(WorkCurveHelper.curFrmThick, null);

                    DisableDpp100();

                    float ratio = countRate / WorkCurveHelper.initCountRate;
                    SetFineToDpp100(InitParam.FineGain / (WorkCurveHelper.fineGainAdjustParam.X * ratio * ratio + WorkCurveHelper.fineGainAdjustParam.Y * ratio + WorkCurveHelper.fineGainAdjustParam.Width));
                    ClearDataDpp100();
                    EnableDpp100();
                ...
                if ((DeviceParam.IsAdjustRate) && usedTime > 1 && !IsAdjust)
                {
                    ...
                    else if (adjustCount == 0)
                    {
                        ...
                        if (WorkCurveHelper.isAdjustSpecData && DeviceParam.TubCurrent == MaxCurrent && isAdjustFineGain == 0)
                        {
                            isAdjustFineGain = 1;
