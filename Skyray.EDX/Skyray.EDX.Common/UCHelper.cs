...
namespace Skyray.EDX.Common
{
    ...
    public class NiCuNiCustomParam
    {
        public double Limit { get; set; }
        /// <summary>
        ///  //总厚度优化系数
        ...
        public string CustomFiled2 { get; set; }
    }
    public class WorkCurveHelper
    {
        ...
        //平台复位点，单位为毫米
        public static float TabResetX = 250.0f;
        public static float TabResetY = 250.0f;
        ...
        public static float ResetX
        {
            get
            {
                return WorkCurveHelper.TabResetX * XCoeff;
            }
        ...
        public static float ResetY
        {
            get
            {
                return WorkCurveHelper.TabResetY * YCoeff;
        ...
        public static bool isAdjustSpecData = false;
        public static RectangleF fineGainAdjustParam = new RectangleF(0, 0, 0, 0);
        public static float initCountRate = 0;
        ...
        public static NiCuNiCustomParam NiCuNiCustomParam = new NiCuNiCustomParam();
        ...
        public static int HistoryTitileHight = 135;
