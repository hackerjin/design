...
#define MX3_PWMIR			0x08    /* PWM Status Register */
...
{
    // 中断处理逻辑
	struct pwm_device* pwm_dev = dev_id;
	//计算下周期的时间T
...
static int imx_pwm_probe(struct platform_device *pdev)
{
	...
	devm_request_irq(&pdev->dev, imx->irq, my_irq_handler,
		  IRQF_TRIGGER_HIGH , "motors", imx->chip.pwms);
